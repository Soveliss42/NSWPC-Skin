...
All images in the basic version were made by me, Soveliss. <br/>
...
RECOMMENDED TO USE THE Switch-Format540p.css CSS IN OBS
...
The Illustrator file included contains everything that's been exported to the basic 540p and 4k assets as of some point (might not stay updated), should you wish to customize this and make your own repo with your own skins.
...
Exporting assets after moving anything, modifying sizes, modifying export sizes, or other changes besides color/clip groups/etc may require changes to the CSS to make it look right.
